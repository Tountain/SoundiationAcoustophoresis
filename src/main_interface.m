...
% set the initial particle position and orientation as [0 0 0], so that the
% incident wave is not translated and rotated transformation.
positionX = 'deviationX = 0;';
positionY = 'deviationY = 0;';
positionZ = 'deviationZ = 0;';
replace_parameters_for_par_initial_position(positionX, positionY, positionZ);

theta_X = ['    theta_x = ','0',';                % particle counter-clock wise rotation (position Tx) along x-axis for positive ''theta_x'''];
theta_Y = ['    theta_y = ','0',';                % particle counter-clock wise rotation (position Ty) along y-axis for positive ''theta_y'''];
theta_Z = ['    theta_z = ','0',';                % particle counter-clock wise rotation (position Tz) along z-axis for positive ''theta_z'''];
...
% write back particle initial position and orientation data
