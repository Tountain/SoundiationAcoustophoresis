function replace_parameters_for_trans_num(trans_num)
%%
% This function is used to change the information 'trans_num' in the
% script "parameters.m".   
...
while feof(fid_parameters) ~= 1 
    ...
    if isempty(strfind(line, 'transducer_number = ')) ~= 1
        line_num_trans_num = ii;
    end
end
