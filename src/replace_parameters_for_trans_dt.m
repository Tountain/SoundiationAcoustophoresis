function replace_parameters_for_trans_dt(trans_dt)
%%
% This function is used to change the information 'inter_dist' in the
% script "parameters.m".   
...
while feof(fid_parameters) ~= 1 
    ...
    if isempty(strfind(line, 'inter_dist = ')) ~= 1
        line_num_trans_dt = ii;
    end
end
