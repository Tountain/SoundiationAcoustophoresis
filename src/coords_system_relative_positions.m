function [r_12, theta_12, phi_12] = coords_system_relative_positions(indx_1, indx_2)
%%
...
particle_1 = particle(indx_1, :);
particle_2 = particle(indx_2, :);

relative_coords = particle_2 - particle_1;
