...
elseif irregular_body == 1
    particle_radius = 2*10^-3;                   % particle radial mean-radius (a); 30 um;
...
b = 0.5 * 0.01;           % integral radial distance (b) for beam-shape coeffcient, EMPIRICAL: MUST follow  b > a and b < inter_dist BUT not b >> a
...
wave_type = 'plain';                   % 'plain', 'zero-Bessel' or 'non-zero-Bessel' and others
