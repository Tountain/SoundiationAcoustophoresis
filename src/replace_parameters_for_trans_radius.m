function replace_parameters_for_trans_radius(trans_radius)
%%
% This function is used to change the information 'trans_radius' in the
% script "parameters.m".   
...
while feof(fid_parameters) ~= 1 
    ...
    if isempty(strfind(line, 'trans_radius = ')) ~= 1
