function replace_parameters_for_trans_v0(trans_v0)
%%
% This function is used to change the information 'v0' in the
% script "parameters.m".   
...
while feof(fid_parameters) ~= 1 
    ...
    if isempty(strfind(line, 'v0 = ')) ~= 1
        line_num_trans_v0 = ii;
    end
end
