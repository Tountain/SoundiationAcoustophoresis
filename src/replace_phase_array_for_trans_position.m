function replace_phase_array_for_trans_position(transducer)
%%
% This function is used to change the information 'transducer' in the
...
while feof(fid_parameters) ~= 1 
    ...
    if isempty(strfind(line, 'transducer = ')) ~= 1
        line_num_trans_position = ii;
    end
end
